...
The app supports image compression, enlargement and object removal which is a combination of the previous two. Below you can see sample results produced by [SIR](https://share.streamlit.io/ngocuong0105/imageresizer/app.py) app. These results are compared with a generic [image resizer](https://resizeimage.net/), which is one of the top results in google search.
